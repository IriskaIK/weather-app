<template>
    <div class="saved_container">
        <div class="saved_list" :class="{ 'opened_list': IsOpen,}">
            ...
            <div class="see_more_btn" @mouseover="isMoreHover = true" @mouseleave="isMoreHover = false"
                @click="ListPressed">
